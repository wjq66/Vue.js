    ...
    <div class="b_right" id="b_right">
		<div class="b_right_breadcrumbs">
			<breadcrumb>
		        ...
		        <breadcrumb-item>打印操作信息</breadcrumb-item>
		    </breadcrumb>
		</div>
		
		<div class="b_right_table">
			<Tabs type="card" @on-click="rouTo" value="5" :animated="false">
		        <TabPane v-for="tab in tablists" :label="tab.name" :name="tab.value">
		        	...
		        	<div class="tabs_table">
						<p class="tableTitle">打印操作信息</p>
						<i-table  :loading='isShow'  stripe border :columns="InformationList_details_printOperation_1" :data="InformationList_details_printOperation_data_1"></i-table>
						<page class="floatRight"  show-elevator @on-change="handlePage(page)" size="small"></page>
					</div>
					<div class="tabs_table">
						<p class="tableTitle">打印机信息</p>
						<i-table  :loading='isShow'  stripe border :columns="InformationList_details_printOperation_2" :data="InformationList_details_printOperation_data_2"></i-table>
						<page class="floatRight"  show-elevator @on-change="handlePage(page)" size="small"></page>
					</div>
		        </TabPane> 
		    </Tabs>
	...
	export default {
        data(){
			return {
				...
				isShow :true,
				InformationList_details_printOperation_1: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_printOperation_2: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_printOperation_data_1:[],
			    InformationList_details_printOperation_data_2:[],
				tablists:[{
					name:'报警信息',
