    ...
    <div class="b_right" id="b_right">
		<div class="b_right_breadcrumbs">
			<breadcrumb>
		        ...
		        <breadcrumb-item>系统审核信息</breadcrumb-item>
		    </breadcrumb>
		</div>
		
		<div class="b_right_table">
			<Tabs type="card" @on-click="rouTo" value="7" :animated="false">
		        <TabPane v-for="tab in tablists" :label="tab.name" :name="tab.value">
		        	...
		        	<div class="tabs_table">
						<p class="tableTitle">策略更改审核详情</p>
						<i-table  :loading='isShow'  stripe border :columns="InformationList_details_systemAudit_1" :data="InformationList_details_systemAudit_data_1"></i-table>
						<page class="floatRight"  show-elevator @on-change="handlePage(page)" size="small"></page>
					</div>
					<div class="tabs_table">
						<p class="tableTitle">系统事件审核详情</p>
						<i-table  :loading='isShow'  stripe border :columns="InformationList_details_systemAudit_2" :data="InformationList_details_systemAudit_data_2"></i-table>
						<page class="floatRight"  show-elevator @on-change="handlePage(page)" size="small"></page>
					</div>
		        </TabPane> 
		    </Tabs>
	...
	export default {
        data(){
			return {
				...
				isShow :true,
				InformationList_details_systemAudit_1: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_systemAudit_2: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_systemAudit_data_1:[],
			    InformationList_details_systemAudit_data_2:[],
				tablists:[{
					name:'报警信息',
