    ...
    <div class="b_right" id="b_right">
		<div class="b_right_breadcrumbs">
			<breadcrumb>
		        ...
		        <breadcrumb-item>文件操作信息</breadcrumb-item>
		    </breadcrumb>
		</div>
		
		<div class="b_right_table">
			<Tabs type="card" @on-click="rouTo" value="2" :animated="false">
		        <TabPane v-for="tab in tablists" :label="tab.name" :name="tab.value">
		        	<div class="tabs_box"  >
						<p class="tableTitle">查询条件</p>
						<div class="tabs_content" style="overflow: hidden;">
							<Form :model="formItem" :label-width="80">
						        <CheckboxGroup v-model="fruit" style="float: left;line-height: 27px;">
							        <Checkbox label="文件流入"></Checkbox>
							        <Checkbox label="文件流出"></Checkbox>
							    </CheckboxGroup>
					        	<DatePicker inline type="daterange" placement="bottom-end" placeholder="时间范围" style="width: 200px;margin-left: 50px;float: left;"></DatePicker>
		        	...
		        	<div class="tabs_table">
						<p class="tableTitle">系统文件操作详情</p>
						<i-table  :loading='isShow'  stripe border :columns="InformationList_details_fileOperation_1" :data="InformationList_details_fileOperation_data_1"></i-table>
						<page class="floatRight"  show-elevator @on-change="handlePage(page)" size="small"></page>
					</div>
					<div class="tabs_table"  >
						<p class="tableTitle">文件拷贝详情</p>
						<i-table  :loading='isShow' stripe border :columns="InformationList_details_fileOperation_2" :data="InformationList_details_fileOperation_data_2"></i-table>
						<page class="floatRight"  show-elevator @on-change="handlePage(page)" size="small"></page>
					</div> 
		        </TabPane> 
		    </Tabs>
	...
	export default {
        data(){
			return {
				...
				isShow :true,
				InformationList_details_fileOperation_1: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_fileOperation_2: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_fileOperation_data_1:[],
			    InformationList_details_fileOperation_data_2:[],
				tablists:[{
					name:'报警信息',
