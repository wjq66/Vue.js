    ...
    <div class="b_right" id="b_right">
		<div class="b_right_breadcrumbs">
			<breadcrumb>
		        ...
		        <breadcrumb-item>网络使用信息</breadcrumb-item>
		    </breadcrumb>
		</div>
		
		<div class="b_right_table">
			<Tabs type="card" @on-click="rouTo" value="3" :animated="false">
		        <TabPane v-for="tab in tablists" :label="tab.name" :name="tab.value">
						...
						<div class="tabs_content">
							<Form :model="formItem" :label-width="80">
						        <CheckboxGroup v-model="fruit" style="float: left;line-height: 27px;">
							        <Checkbox label="网络流入"></Checkbox>
							        <Checkbox label="网络流出"></Checkbox>
							    </CheckboxGroup>
		        	...
		        	<div class="tabs_table">
						<p class="tableTitle">网络使用详细信息</p>
						<i-table  :loading='isShow'  stripe border :columns="InformationList_details_netUse_1" :data="InformationList_details_netUse_data_1"></i-table>
	...
	export default {
        data(){
			return {
				...
				isShow :true,
				InformationList_details_netUse_1: [
			        {
			            title: '序号',
			            key: 'serialNumber',
			            width:120,
			    ...
			    InformationList_details_netUse_data_1:[],
				tablists:[{
					name:'报警信息',
